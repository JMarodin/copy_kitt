...
const CopyKitt: React.FC = () => {
  ...
  const ENDPOINT: string =
    "https://8c1i5j9m3e.execute-api.sa-east-1.amazonaws.com/prod/generate_snippet";
  ...
  const onSubmit = () => {
    ...
    console.log("endpoint: " + `${ENDPOINT}?prompt=${prompt}`);
    setIsLoading(true);
      ...
      <div className="max-w-md m-auto p-2">
        <div className="bg-slate-800 p-6 rounded-md text-white">
          <div className="text-center my-6">
            <Image src={logo} width={42} height={42} alt="str" />
          ...
          <p>Developed by Julio Marodin</p>
      </div>
    </div>
  );
};
